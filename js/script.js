...
periodSelect.addEventListener('input', function() { //4
    ...
    // incomePeriodValue.value = appData.calcSavedMoney(); //5 не очень поняла формулировку вопроса, что нужно добавить обработчик внутри метода showResult. Как он будет отслеживать range, если он вызывается только при нажатии кнопки "Рассчитать"? А так работает.
});
